...
_SEVERITY_COLORS = {
    Severity.BLOCKS_TRANSMISSION: colors.HexColor("#cc100a"),
    Severity.WILL_CAUSE_CHARGEBACK: colors.HexColor("#ee8a2a"),
    Severity.MAY_CAUSE_CHARGEBACK: colors.HexColor("#f9c31f"),
    Severity.COSMETIC: colors.HexColor("#b3b3b3"),
}

_SEVERITY_BG = {
    Severity.BLOCKS_TRANSMISSION: colors.HexColor("#fce8e7"),
    Severity.WILL_CAUSE_CHARGEBACK: colors.HexColor("#fdeee0"),
    Severity.MAY_CAUSE_CHARGEBACK: colors.HexColor("#fef5d8"),
    Severity.COSMETIC: colors.HexColor("#e8eaf4"),
}
...
def _build_header(result: ValidationResult, retailer_label: str) -> list:
    ...
    if result.is_valid:
        ...
        pass_style.textColor = colors.HexColor("#0e6e5a")
...
def _build_findings_section(
    ...
    desc_style.textColor = colors.HexColor("#666666")
